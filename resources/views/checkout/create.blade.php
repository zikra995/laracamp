                        ...
                        <div class="col-lg-6 col-12">
                             <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="post">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="card_number" type="number" class="form-control {{ $errors->has('card_number') ?'is-invalid' : '' }} "  value="{{old('card_number') ?: Auth::user()->occupation }}" required />
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="expired" type="month" class="form-control {{ $errors->has('expired') ?'is-invalid' : '' }} "  value="{{old('expired') ?: Auth::user()->expired }}" required />
                                    ...
                                    @endif
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number" class="form-control {{ $errors->has('cvc') ?'is-invalid' : '' }}  maxleght="5"  value="{{old('cvc') ?: '' }}" required/>
                                        </div>
                                        @if ($errors->has('cvc'))
